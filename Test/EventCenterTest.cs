...
public class EventCenterTest : MonoBehaviour, IListener
{
    ...
    private void OnEnable()
    {
        ...
        this.AddListener<EventEnumType, string>(EventEnumType.EventCenterTest, EventCenterTestDo);
    ...
    void EventCenterTestDo(string str)
    {
